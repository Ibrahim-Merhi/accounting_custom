...
REQUIRED_DOCTYPES = {
	...
	"Accounting Currency Exchange": {"company", "posting_date", "from_mode_of_payment", "source_account", "from_currency", "from_amount", "to_mode_of_payment", "target_account", "to_currency", "exchange_rate", "to_amount", "remarks", "journal_entry"},
